        ...
        <div class="row align-items-center">
            <div class="col">
              <div class="d-flex align-items-center gap-4">
                <h1 class="h4 ls-tight headingColor">Add Center</h1>
              </div>
            </div>
            <div class="col-auto">
          ...
          <div class="row py-4">
            ...
            <div class="col-md-6 col-12 mb-2">
              ...
              <div class="input-group mb-3">
                ...
                <select class="form-select iconInput form-select-sm" aria-label="Default select example">
            ...
            <h5 className="mt-4 text-warning mb-3 headingColor">Center Break </h5>
            <div class="col-md-6 col-12 mb-2">
              <lable class="">
            ...
            <div class="form-floating">
              ...
              <textarea class="form-control" style={{ height: 150 }}></textarea>
            </div>
